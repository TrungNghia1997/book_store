        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    <a href="{{url('/')}}/admin/category" class="dropdown-toggle"  aria-haspopup="true" aria-expanded="false"><i class="menu-icon fa fa-cogs"></i> Danh mục sản phẩm</a>

                </li>
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-cogs" @if( Request::is('admin/author/*')) active @endif></i>Tác giả</a>
                ...
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-cogs" @if( Request::is('admin/product/*')) active @endif></i>Sản phẩm</a>
                    <ul class="sub-menu children dropdown-menu">
                ...
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-cogs" @if( Request::is('admin/feedback/*')) active @endif></i>Phản hồi khách hàng</a>
                    <ul class="sub-menu children dropdown-menu">
                ...
                <li class="menu-item-has-children dropdown @if( Request::is('admin/user/*') || Request::is('admin/user/') ) active @endif">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Thành viên</a>
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="{{url('/')}}/admin/user/create">Thêm thành viên</a></li>
