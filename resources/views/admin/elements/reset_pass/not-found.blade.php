    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <label style="margin-top: 50px; margin-left: 100px; font-size: 20px;">Vui lòng cung cấp địa chỉ email đã đăng kí</label>
                <hr>

                <form class="login100-form validate-form" method="POST" action="/api/password/create">
                    @csrf
                    ...
                    <p style="color: red">Email không hợp lệ! Vui lòng nhập lại email!</p>
