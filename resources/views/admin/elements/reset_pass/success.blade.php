    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <label style="margin-top: 50px; margin-left: 100px; font-size: 20px;"></label>
                <hr>




                    <div class="wrap-input100 validate-input m-b-26" data-validate="Username is required" style="padding: 40px;">
                        <label>Chúng tôi đã gửi thông báo đặt lại mật khẩu đến email của bạn, vui lòng kiểm tra mail để tiếp tục.</label>


                    </div>

                     <div class="container-login100-form-btn" >
                        <a href="{{url('/')}}/admin/login" title="" class="login100-form-btn" style=" margin: auto; margin-bottom: 29px;">Quay lại trang đăng nhập</a>
                    </div>
