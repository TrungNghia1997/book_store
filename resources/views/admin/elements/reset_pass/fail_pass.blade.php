        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <hr>
                    ...
                    <div class="wrap-input100 validate-input m-b-26" data-validate="Username is required" style="padding: 40px; text-align: center;">
                        <label>Yêu cầu đặt lại mật khẩu không hợp lệ!!!</label>
                        @if(session('thongbao'))
